...
| **p7-oneshot** | Team | **62.01** | **4 ms** | **48 / 68 ms**| **5** | 🏆 **NEW ALL-TIME MVP**| Image `:p7-oneshot` (v0.26.0) + FlashInfer Align + `mbt=768` + `seqs=128`. **TTFT p95 hạ từ 70ms xuống 68ms** (**+0.35 điểm** vs #10). |
